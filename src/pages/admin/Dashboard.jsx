                            ...
                            <div className="card mb-4">
                                <div className="card-header border-0">
                                    ...
                                    <div className="card-tools">
                                        <a href="#" className="btn btn-tool btn-sm"> <i className="bi bi-download"></i> </a>
                                        <a href="#" className="btn btn-tool btn-sm"> <i className="bi bi-list"></i> </a>
                                    </div>
                                </div>
                                <div className="card-body table-responsive p-0">
                                    <table className="table table-striped align-middle" role="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="./assets/img/default-150x150.png" alt="Product 1" className="rounded-circle img-size-32 me-2" />
                                                    Some Product
                                                </td>
                                                <td>$13 USD</td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="#" className="text-secondary"> <i className="bi bi-search"></i> </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                        ...
                        <div className='col-lg-6 connectedSortable'>
                            ...
                            <div className="card mb-4">
                                <div className="card-header border-0">
                                    ...
                                    <div className="card-tools">
                                        <a href="#" className="btn btn-sm btn-tool"> <i className="bi bi-download"></i> </a>
                                        <a href="#" className="btn btn-sm btn-tool"> <i className="bi bi-list"></i> </a>
                                    </div>
                                </div>
                                <div className="card-body">
                                    <div className="d-flex justify-content-between align-items-center border-bottom mb-3">
                                        <p className="text-success fs-2">
                                            <svg height="32" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
