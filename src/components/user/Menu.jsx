...
export default function Menu() {
    return (
        <>
            ...
            <li className="nav-item">
                <NavLink className={({ isActive }) => `nav-link-menu ${isActive ? "active" : "nav-link-menu px-2 "}`} to="/rental">Sản phẩm cho thuê</NavLink>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
                <NavLink className={({ isActive }) => `nav-link-menu ${isActive ? "active" : " nav-link-menu px-2 "}`} to="/about">Giới thiệu</NavLink>
            </li>
        </>
