...
export default function ImagesEdit({ form, setForm }) {
                            ...
                            {localImages.map((img, idx) => (
                                <div key={idx} className="text-center px-2">
                                    <InnerImageZoom
                                        ...
                                        zoomSrc={img.src.startsWith('data:') ? img.src : process.env.REACT_APP_API_URL + img.src}
                                        zoomType="hover"
                                        zoomScale={2}
                                        alt={img.altText || `Ảnh sản phẩm ${idx + 1}`}
